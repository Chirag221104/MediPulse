    ...
    if (isError) {
        return (
            <View style={[styles.center, { backgroundColor: theme.background }]}>
                <Text style={[styles.errorText, { color: theme.error }]}>Failed to load patients</Text>
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            {(!patients || patients.length === 0) ? (
                <View style={styles.center}>
                    ...
                    <Text style={[styles.emptySubtext, { color: theme.inactive }]}>Add your first patient profile</Text>
                </View>
            ) : (
                <FlatList
                    data={patients}
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={[styles.detail, { color: theme.textSecondary }]}>{item.relation} • {item.age}y • {item.gender}</Text>
                            </View>
            ...
            <TouchableOpacity style={[styles.fab, { backgroundColor: theme.primary }]} onPress={() => router.push('/patients/add')}>
...
function getStyles(theme: any) {
    return StyleSheet.create({
        ...
        activeCard: { borderColor: theme.primary, borderWidth: 2, backgroundColor: theme.primarySurface },
        avatar: {
